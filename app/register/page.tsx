...
const page = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            const resUserExists = await fetch("api/existeduser", {
                method: "POST",
                headers: {
                ...
                <div className="p-8 lg:w-1/2 mx-auto">
                    <div className="rounded-t-lg p-8">
                        <div className='flex items-center justify-center space-x-4 mt-3 flex-col'>
                            <p className="text-center text-white z-40 text-2xl font-semibold">Sign Up</p>
                            ...
                            <div className="relative">
                                <div className="relative mt-3">
                                    ...
                                    <div className="absolute left-0 inset-y-0 flex items-center">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="h-7 w-7 ml-3 mb-8 text-gray-400 p-1"
                                            viewBox="0 0 20 20"
                                            fill="currentColor"
                                        >
                                            <path
                                    ...
                                    <div className='flex pt-2 justify-between px-1'>
                                        ...
                                        <Link href="/login" className='hover:text-[#FCCB08] duration-150 underline'>Login</Link>
                                    </div>
                                </div>
                                {/* error massage */}
                                {error &&
