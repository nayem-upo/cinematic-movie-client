...
const MovieCard: React.FC<MovieCardProps> = ({ movie }) => {
    ...
    return (
        <div className="example-2 card mx-auto">
            <div className="wrapper md:min-h-[320px] min-h-[360px] w-[300px] md:w-auto duration-300 hover:scale-105 bg-center bg-cover bg-no-repeat" style={{ backgroundImage: `url(${movieImage})` }}>
