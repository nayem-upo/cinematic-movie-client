...
const MovieCard: React.FC<MovieCardProps> = ({ movie }) => {
    ...
    return (
        <div className="example-2 card mx-auto">
            <div className="wrapper md:min-h-[320px] md:w-[250px] w-[300px] min-h-[320px] duration-300 hover:scale-105 bg-center bg-cover bg-no-repeat" style={{ backgroundImage: `url(${movieImage})` }}>
