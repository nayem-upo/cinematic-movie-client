...
const Header = () => {
    return (
        <div className='sticky top-0 z-50 shadow-xl'>
            <div className='flex items-center bg-[#1B1B1B] justify-between px-4'>
                <Link href={"/"}><img className='w-16 cursor-pointer' src="https://i.ibb.co/tBtY92n/Colorful-Modern-Stream-C-Free-Logo.png" alt="" /></Link>
                <div className='flex gap-4 items-center'>
                    <div className="relative flex items-center">
                        ...
                        <input type="search" className="block w-[600px] px-2 py-2 pl-10 text-sm text-white outline-none rounded-md shadow-md" placeholder="Search movie or theatres..." required />
                    </div>
